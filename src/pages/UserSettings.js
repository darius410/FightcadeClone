  ...
  return (
    ...
    <button className="playerIcon hover:w-[90px] ease-in-out duration-150">
        ...
        <span className="activeStatus"></span>
                  ...
                  <p className="text-primaryHighlight  font-primary font-bold ">Fightcade ID</p>
          ...
          <div className="flex flex-col w-4/5 border-b-2 mb-[10%] m-auto border-primaryHighlight">
              ...
              <p className="text-blackfont-primary font-bold mb-3 ">Email</p>
              <span>darius_hansley@yahoo.com</span>
        </div>

        <div className="flex flex-col m-auto w-4/5 border-b-2 mb-[10%] border-primaryHighlight ">
              
              <p className="text-blackfont-primary font-bold mb-3 ">Password</p>
              <span>**********</span>
        </div>
          ...
          <div className="w-full text-center justify-center  place-content-center border-b-2 mb-[10%] border-primaryHighlight">
            ...
            <div className="w-full flex flex-col ">
                  ...
                  <p className="text-primaryHighlight font-primary font-bold ">GAMES</p>
...
<select id="dropdown" className="hidden">
  ...
  <option value="green">Green</option>
                ...
                <div className="flex flex-row content-center justify-evenly ">
                  ...
                  <span className="mb-5 text-xs ">Ranked Player</span>
                ...
                <div className="flex justify-evenly">
                  ...
                  <span className="mb-5 text-xs ">Prevent Low Quality Changes</span>
                    <input type="checkbox" onclick="return false;"/>
                  ...
                  <span className="mb-5 text-xs ">Prevent Wifi/ VPN Challenges</span>
                    <input type="checkbox" onclick="return false;"/>
                  ...
                  <span className="mb-5 text-xs ">Disable Live Spectactors</span>
                    <input type="checkbox" onclick="return false;"/>
