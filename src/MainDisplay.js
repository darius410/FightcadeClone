...
const MainDisplay = () => (
     <div className="mainLayoutContainer flex flex-col font-secondary h-[1200px]"> 
  {/* container */}
     <div className="mainLayout flex flex-col place-items-center">
          {/* TOP */}
            <div className=" mt-16 flex mb-16"> 
             <img src="./fightcade.svg" alt="" width="600rem"/>
            ...
            <div className="flex flex-row text-green-200 ">
                <div className="">
                    <h1 className=" text-primaryHighlightDim text-5xl font-semibold ">WHAT IS FIGHTCADE ?</h1>
                    <h3 className="text-4xl mt-6 font-semibold hover:text-secondaryHighlight ">About</h3>
                </div>

                <div className="mx-36 border-x-2 border-solid border-x-primaryHighlight px-44">
                <h1 className=" text-primaryHighlightDim text-5xl font-semibold">FIRST TIME HERE ?</h1>
                    <h3 className="text-4xl mt-6 font-semibold hover:text-secondaryHighlight">READ MANUAL</h3>
                </div>
                
                <div>
                <h1 className=" text-primaryHighlightDim text-5xl font-semibold">GOT QUESTIONS ?</h1>
                    <h3 className="text-4xl mt-6 font-semibold hover:text-secondaryHighlight">F.A.Q</h3>
                </div>
            </div>
    ...
    {/* BOTTOM */}
     <div className="mainLayoutBottom  flex flex-col place-items-center pt-32">
        <div className="flex flex-row w-22 justify-evenly items-center" > 
        ...
        <path d="M243.461.01H230.1v39.985l13.361.005a20 20 0 0 0 0-39.99zm0 28.566h-1.933V11.434h1.933a8.571 8.571 0 0 1 0 17.142z">
            ...
            <p className="font-patreon text-white text-6xl font-medium tracking-widest border-r-8 py-8 pr-8">PATREON</p>
            ...
            <div className="flex justify-around w-11/12 mx-22 text-white text-4xl border-t-2 border-primaryHighlight relative top-[70px] ">
                <div className=" relative top-12">Join Our Community
